...
int main()
{
		...
		// Existen mas tipos de datos, ya que por logica y definicion, el alcance de lo que se puede almacenar en un dato es infinito.
		// Vease color como tipo de dato, puede tomar todo el espectro de colores, y si bien no es un tipo de dato definido en C++
		// Puede serlo por nuestra propia implementacion.
		// Ej adicionales: Temperatura, Altura, Metrologia, etc.
}
